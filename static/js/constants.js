...
const arrFreeRoamResources={
	...
	'vallisCycle':
	{
		...
		'hunting':{
			...
			'Flossy':{'class':'Sawgaw','pack':'1','shoots':'1','desc':'Soar Gore as the Solaris call it, this crimson-faced bird of prey circles and stalks the cliffs and fungal groves of Venus, searching for rodent prey.','cycle':'Any','agressive':'0','img':'','perfect':'800','good':'600','bad':'400'},
			'Alpine':{'class':'Sawgaw','pack':'1','shoots':'1','desc':'Soar Gore as the Solaris call it, this crimson-faced bird of prey circles and stalks the cliffs and fungal groves of Venus, searching for rodent prey.','cycle':'Any','agressive':'0','img':'','perfect':'1200','good':'900','bad':'600'},
			'Frogmouthed':{'class':'Sawgaw','pack':'1','shoots':'1','desc':'Soar Gore as the Solaris call it, this crimson-faced bird of prey circles and stalks the cliffs and fungal groves of Venus, searching for rodent prey.','cycle':'Any','agressive':'0','img':'','perfect':'1800','good':'1350','bad':'900'},
			'Dappled':{'class':'Horrasques','pack':'1','shoots':'3','desc':'This hideous creature is terrible to behold but will not attack unless provoked. When it does, its roar will shake the bowels of even the most steadfast tracker.','cycle':'Any','agressive':'0','img':'','perfect':'1200','good':'900','bad':'600'},
			'Swimmer':{'class':'Horrasques','pack':'1','shoots':'3','desc':'This hideous creature is terrible to behold but will not attack unless provoked. When it does, its roar will shake the bowels of even the most steadfast tracker.','cycle':'Any','agressive':'0','img':'','perfect':'2400','good':'1800','bad':'-'},
			'Stormer':{'class':'Horrasques','pack':'1','shoots':'3','desc':'This hideous creature is terrible to behold but will not attack unless provoked. When it does, its roar will shake the bowels of even the most steadfast tracker.','cycle':'Any','agressive':'0','img':'','perfect':'3600','good':'2700','bad':'1800'},
			'Sentinel':{'class':'Stover','pack':'3','shoots':'3','desc':'The Stover is a kind of proto-Kubrow that resurrected when Venus thawed. When grouped in a pack, Stovers are relentless opponents.','cycle':'Any','agressive':'1','img':'','perfect':'1600','good':'1200','bad':'800'},
			'Fuming Dax':{'class':'Stover','pack':'3','shoots':'3','desc':'The Stover is a kind of proto-Kubrow that resurrected when Venus thawed. When grouped in a pack, Stovers are relentless opponents.','cycle':'Any','agressive':'1','img':'','perfect':'3200','good':'2400','bad':'1600'},
			'Fire-Veined':{'class':'Stover','pack':'3','shoots':'3','desc':'The Stover is a kind of proto-Kubrow that resurrected when Venus thawed. When grouped in a pack, Stovers are relentless opponents.','cycle':'Any','agressive':'1','img':'','perfect':'6400','good':'4800','bad':'3200'}
